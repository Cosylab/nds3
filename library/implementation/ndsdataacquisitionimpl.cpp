    ...
    m_startTimestampFunction(std::bind(&BaseImpl::getTimestamp, this))
{
    ...
    m_dataPV->setScanType(interrupt, 0);
    ...
    m_frequencyPV->setScanType(passive, 0);
    m_frequencyPV->setType(ai);
    ...
    m_durationPV->setScanType(passive, 0);
    m_durationPV->setType(ai);
    ...
    m_maxElementsPV->setScanType(passive, 0);
    m_maxElementsPV->setType(longin);
    ...
    m_decimationPV->setScanType(passive, 0);
    m_decimationPV->setType(longin);
